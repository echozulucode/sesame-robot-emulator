...
export function emitSesameCpp(doc: SequenceDoc, options: CppExportOptions = {}): string {
  ...
  if (header) {
    lines.push(
      '// ---------------------------------------------------------------------',
      '// Generated by Sesame Robot Emulator. Paste into firmware/movement-sequences.h and',
      ...
      '// physical robot: Sesame Robot Emulator has never driven one and cannot. What the',
